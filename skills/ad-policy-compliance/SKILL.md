...
description: Checks ad creative and landing pages against platform advertising policies for Google, Meta, LinkedIn, TikTok, and Reddit. Use when pre-checking ads for policy compliance, fixing rejected ads, reviewing restricted content, or navigating industry-specific ad rules.
---
...
- **Google Ads Policy Scan**: Restricted content, editorial, trademark, claims
- **Meta Ads Policy Scan**: Special Ad Categories, prohibited content, targeting restrictions
- **LinkedIn Ads Policy Checklist**: Professional standards, B2B compliance
- **TikTok Ads Policy Check**: Authenticity, community guidelines, restricted products
- **Reddit Ads Policy Check**: Community standards, transparency rules
- **Industry-Specific Rules**: Finance, healthcare, alcohol, political, gambling, cannabis
- **Pre-Submission Workflow**: Automated policy scan before ad creation
- **Rejection Fix Playbook**: Common rejections and proven solutions

## Workflows

### 1. Pre-Submission Policy Scan
...
CREDIT:
  Applies to: Credit cards, loans, insurance, financial services
  Restrictions: Same as Housing
...
⚠️ RESTRICTED (requires approval):
  ...
  - Cryptocurrency (licensed exchanges only, no ICOs)
  - Prescription drugs (must target only authorized countries)
  - Financial products (must include disclaimers)
```
...
### 4. LinkedIn Ads Policy Checklist
...
SPONSORED INMAIL / MESSAGE ADS:
  ...
  ❌ Cannot exceed frequency caps (1 InMail per 45 days per user)
  ❌ Cannot send unsolicited commercial messages
```

### 5. TikTok Ads Policy Checklist
...
PROHIBITED:
  ...
  ❌ Cryptocurrency (most markets — some exceptions)
  ❌ Payday loans
...
RESTRICTED:
  ...
  ⚠️ Financial services: Must include risk disclaimers
  ⚠️ Health supplements: Must not make medical claims
...
GOOGLE ADS SPECIFIC:
  ...
  - Requires Google advertiser verification for some products
  - Loan ads: Must show APR, repayment terms
  - Crypto: Allowed for licensed exchanges (requires certification)
...
META SPECIFIC:
  ...
  - Crypto: Licensed exchanges only, no ICOs or DeFi protocols
```
...
ALL PLATFORMS:
  ...
  ❌ No prescription drug promotion to consumers (US — varies by country)
...
TIKTOK SPECIFIC:
  - No weight loss products at all
  - Health supplements with very limited claims
...
PLATFORM STATUS:
  ...
  LinkedIn: ✅ Allowed with age targeting
  TikTok: ⚠️ Allowed in select markets only (US, UK, some EU)
...
GOOGLE ADS:
  ...
  ✅ "Paid for by" disclaimer required
  ✅ Stored in Google Ads Transparency Center
  ✅ Must comply with local election laws
  ❌ No micro-targeting by political affiliation (EU)
  ❌ No deep fakes or manipulated media
...
META:
  ...
  ❌ Restricted targeting (no interests, demographics for political ads)
...
REDDIT:
  ✅ Allowed with transparency requirements
  ✅ Must identify advertiser clearly
  ❌ No issue ads targeting specific geographies
...
|-----------|----------|-------|-----|
| "Misleading content" | Google | Exaggerated claims, clickbait | Remove superlatives, add qualifiers |
| "Circumventing systems" | Google | Redirects, cloaking | Use direct URLs, no redirect chains |
| "Unacceptable business model" | Google | MLM, get-rich-quick | Restructure LP to remove income claims |
...
| "Trademark violation" | Google | Using competitor brand in ad text | Remove trademark or get authorization |
| "Restricted content" | All | Alcohol, gambling without age gate | Add age targeting, required disclaimers |
| "Destination mismatch" | Google | Ad about X, LP about Y | Align LP content with ad copy |
| "Malware/unwanted software" | Google | Sketchy LP, auto-downloads | Remove any downloads, fix SSL |
| "Low quality" | LinkedIn | Clickbait, unprofessional | Professional tone, clear value prop |

### 8. Trademark Usage Rules by Platform

| Rule | Google | Meta | LinkedIn | TikTok | Reddit |
|------|--------|------|----------|--------|--------|
...
| LinkedIn | Campaign Manager → Contact Support | 3-5 business days | 40-60% |
| TikTok | Ad rejected → Appeal button | 1-3 business days | 25-45% |
| Reddit | Email support@reddithelp.com | 3-7 business days | 30-50% |

### Pre-Launch Compliance Checklist Template
